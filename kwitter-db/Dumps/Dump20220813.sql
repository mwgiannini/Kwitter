...
INSERT INTO `favorite` VALUES ('frank','2022-07-11 10:00:00','frank'),('frank','2022-07-11 10:00:00','humphrey_dumpty'),('cat_god','2022-07-23 02:30:03','me_wang'),('frank','2022-07-11 10:00:00','me_wang'),('frank','2022-07-11 10:00:00','mw'),('tut_the_gut','2022-07-14 04:00:34','mw'),('tut_the_gut','2022-07-23 05:45:59','mw'),('frank','2022-07-11 10:00:00','tut_the_gut');
...
INSERT INTO `follow` VALUES ('frank','cat_god'),('cat_god','humphrey_dumpty'),('frank','me_wang'),('frank','mw'),('tut_the_gut','mw'),('cat_god','tut_the_gut');
...
INSERT INTO `kweet` VALUES ('cat_god','2022-07-10 08:45:00','Cat church need more donations to purchase a betafish tank for entertainment, Amen'),('cat_god','2022-07-23 02:30:03','Has anyone seen brother Humphrey?'),('frank','2022-07-11 10:00:00','Graham, WHERE ARE YOU???!!!'),('humphrey_dumpty','2022-07-22 18:02:34','My brother is an annoying narcissist'),('me_wang','2022-07-23 12:48:00','We all know who did it #lockhimup'),('mw','2022-07-23 11:34:34','#freetut'),('mw','2022-08-12 22:52:53','T - 1:08'),('mw','2022-08-13 00:11:14','Congratulations to the team on a successful launch “-“ '),('tut_the_gut','2022-07-12 05:12:20','What is your philisophical argument on the simplecomplexities of philogeny?'),('tut_the_gut','2022-07-14 04:00:34','Gosh I am pretty!'),('tut_the_gut','2022-07-22 18:20:34','How can I get rid of a dead cat?'),('tut_the_gut','2022-07-23 05:45:59','On my way to prison #noregrets'),('tut_the_gut','2022-08-12 21:57:32','ISO: Good recipes to cook betta fish ');
...
CREATE TABLE `rekweet` (
  ...
  PRIMARY KEY (`rekweet_username`,`username`,`post_time`,`rekweet_time`),
  KEY `fk_User_has_kweet_kweet1_idx` (`username`,`post_time`),
  KEY `fk_User_has_kweet_User1_idx` (`rekweet_username`),
  CONSTRAINT `fk_User_has_kweet_kweet1` FOREIGN KEY (`username`, `post_time`) REFERENCES `kweet` (`username`, `post_time`),
...
INSERT INTO `rekweet` VALUES ('frank','frank','2022-07-11 10:00:00','2022-07-11 11:00:00'),('frank','frank','2022-07-11 10:00:00','2022-07-11 12:00:00'),('frank','frank','2022-07-11 10:00:00','2022-07-11 13:00:00'),('frank','frank','2022-07-11 10:00:00','2022-07-11 14:00:00'),('frank','frank','2022-07-11 10:00:00','2022-07-11 15:00:00'),('frank','frank','2022-07-11 10:00:00','2022-07-11 16:00:00'),('humphrey_dumpty','cat_god','2022-07-10 08:45:00','2022-07-10 08:45:10'),('mw','tut_the_gut','2022-07-14 04:00:34','2022-08-12 21:02:10'),('mw','tut_the_gut','2022-07-22 18:20:34','2022-08-12 21:02:08'),('mw','tut_the_gut','2022-07-23 05:45:59','2022-08-12 21:02:07'),('tut_the_gut','cat_god','2022-07-10 08:45:00','2022-08-12 20:50:27');
...
INSERT INTO `user` VALUES ('12313123','1231231',NULL),('cat_god','catRulesTheWorld','https://mir-s3-cdn-cf.behance.net/project_modules/disp/73db5b18439129.562c97b4b62ad.jpg'),('frank','123456','frank hates null'),('humphrey_dumpty','drowssap','filled with data'),('me_wang','vesper','\"NULL\"'),('mw','murphy','real picture'),('tut','',NULL),('tut_the_gut','password','definitely no nul');
...
/*!50003 DROP PROCEDURE IF EXISTS `get_following_posts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `get_following_posts`(
	IN this_username VARCHAR(20)
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_following_rekweets` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `get_following_rekweets`(
	IN this_username VARCHAR(20)
)
BEGIN
...
BEGIN
INSERT INTO kweet(username, post_time, message) VALUES(
	username,
    Now(),
	message
);
...
DELETE FROM rekweet
			...
			AND post_time = kweet_time;
ELSE
INSERT INTO rekweet(rekweet_username, username, post_time, rekweet_time)
	VALUES(rekweeter, kweeter, kweet_time, NOW());
END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2022-08-13  0:26:47
